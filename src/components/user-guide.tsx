          ...
          <div className="space-y-6 text-sm text-foreground">
            ...
            <div>
              ...
              <ul className="list-disc pl-5 space-y-2">
                <li>
                  <strong>Создать новую комнату:</strong> Нажмите на эту кнопку, и для вас будет сгенерирована уникальная комната с кодом от 4 до 10 символов. Вы автоматически попадёте в неё.
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="list-disc pl-5 space-y-2">
                ...
                <li><b className="font-mono">Ручка, Стрелка, Прямоугольник, Эллипс, Треугольник:</b> Инструменты для создания соответствующих фигур.</li>
