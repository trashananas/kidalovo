            ...
            <div>
                ...
                <ul className="list-disc pl-5 space-y-2">
                    <li>
                     ...
                     <li>
                        <strong>Прикрепление файлов и изображений:</strong> Нажмите на иконку скрепки. Вы можете прикрепить любой файл.
                        <ul className="list-disc pl-5 mt-2">
                            <li>Если вы выберете <strong>изображение</strong> (JPG, PNG и т.д.), оно будет отображаться прямо на карточке.</li>
                            <li>Если вы выберете <strong>другой тип файла</strong> (документ, архив и т.д.), на карточке появится его название и кнопка для скачивания.</li>
                        </ul>
                        <p className="mt-2">Вы можете отправить файл как с текстом, так и без него.</p>
                         <div className="mt-2 text-xs text-muted-foreground p-2 border border-dashed rounded-md">
                          <p><strong>Важно о загрузке файлов:</strong></p>
                          <p>Приложение сначала пытается использовать облачное хранилище (Firebase Storage). Если оно недоступно (например, не настроено), включается резервный метод загрузки. <strong>Лимит размера файла для резервного метода — 750 КБ.</strong> Файлы большего размера не могут быть загружены, пока хранилище не будет полностью настроено.</p>
                        </div>
                    </li>
                    <li>
