          ...
          <div className="space-y-6 text-sm text-foreground">
            ...
            <div>
              ...
              <ul className="list-disc pl-5 space-y-2">
                <li>
                  <strong>Создать новую комнату:</strong> Нажмите на эту кнопку, и для вас будет сгенерирована уникальная комната с 4-значным кодом. Вы автоматически попадёте в неё.
                </li>
                <li>
