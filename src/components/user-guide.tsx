            ...
            <div>
                ...
                <ul className="list-disc pl-5 space-y-2">
                    <li>
                     ...
                     <li>
                        <strong>Прикрепление файлов:</strong> Нажмите на иконку скрепки, чтобы выбрать и прикрепить любой файл к вашему сообщению. Вы можете отправить файл как с текстом, так и без него. После отправки другие участники смогут скачать этот файл. Из-за технических ограничений, размер файла не должен превышать 1 МБ.
                    </li>
                    <li>
