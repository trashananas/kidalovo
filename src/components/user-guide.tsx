                     ...
                     <li>
                        ...
                        <ul className="list-disc pl-5 mt-2">
                         ...
                         <div className="mt-2 text-xs text-muted-foreground p-2 border border-dashed rounded-md">
                          <p><strong>Важное ограничение на размер файлов:</strong></p>
                          <p>Так как приложение не использует внешнее облачное хранилище, максимальный размер прикрепляемого файла ограничен <strong>750 КБ</strong>. При попытке загрузить файл большего размера вы увидите ошибку.</p>
                        </div>
                    </li>
                    <li>
