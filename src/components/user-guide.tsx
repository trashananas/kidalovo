                ...
                <ul className="list-disc pl-5 space-y-2">
                    <li>
                     ...
                     <li>
                        ...
                        <p className="mt-2">Вы можете отправить файл как с текстом, так и без него. Файлы хранятся прямо в базе данных, что накладывает ограничение на их размер. Чтобы избежать ошибок при загрузке, пожалуйста, используйте файлы размером <strong>до 750 КБ</strong>.</p>
                    </li>
                    <li>
