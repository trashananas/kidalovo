        ...
        <ScrollArea className="h-[70vh] pr-6">
          <div className="space-y-6 text-sm text-foreground">
            <div>
              ...
              <p>
                "Доска для записок" — это простое приложение для совместной работы с текстовыми заметками в реальном времени. Создавайте комнаты, приглашайте друзей и обменивайтесь идеями в виде стикеров на виртуальной доске.
              </p>
            </div>
