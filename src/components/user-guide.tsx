                    ...
                    <li>
                     ...
                     <li>
                        ...
                        <p className="mt-2 text-xs text-muted-foreground">
                          Приложение пытается использовать облачное хранилище для быстрой загрузки больших файлов. Если оно недоступно, файлы размером до 750КБ будут загружены напрямую. Файлы большего размера не могут быть загружены до восстановления хранилища.
                        </p>
                    </li>
                    <li>
